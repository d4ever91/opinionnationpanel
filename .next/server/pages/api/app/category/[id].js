...
handler.get(async (req, res)=>{
    try {
        ...
        var category = await (0,_lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_3__/* .findCategory */ .b5)({
            _id: req.query.id
        });
        return (0,_lib_utils_response__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(req, res, _lib_utils_statusCodes__WEBPACK_IMPORTED_MODULE_5__/* ["default"].SUCCESS */ .Z.SUCCESS, "", "", category);
    } catch (err) {
...
var __webpack_exports__ = __webpack_require__.X(0, [3796,902,104,6996,880,9707], () => (__webpack_exec__(4389)));
