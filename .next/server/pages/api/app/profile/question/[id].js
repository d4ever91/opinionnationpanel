...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([next_connect__WEBPACK_IMPORTED_MODULE_2__, _lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_3__]);
([next_connect__WEBPACK_IMPORTED_MODULE_2__, _lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
handler.get(async (req, res)=>{
    try {
        ...
        var questions = await (0,_lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_3__/* .findQuestions */ .kM)({
            category: req.query.id
        });
        return (0,_lib_utils_response__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(req, res, _lib_utils_statusCodes__WEBPACK_IMPORTED_MODULE_5__/* ["default"].SUCCESS */ .Z.SUCCESS, "", "", questions);
    } catch (err) {
...
var __webpack_exports__ = __webpack_require__.X(0, [3796,902,104,6996,880,9707], () => (__webpack_exec__(9843)));
