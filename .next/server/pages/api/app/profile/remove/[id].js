...
handler.delete(async (req, res)=>{
    try {
        ...
        var user = await (0,_lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_6__/* .updateUserById */ .TP)(req.query.id, {
            isDeleted: true
        });
        return (0,_lib_utils_response__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(req, res, _lib_utils_statusCodes__WEBPACK_IMPORTED_MODULE_4__/* ["default"].SUCCESS */ .Z.SUCCESS, "", _lib_utils_messages__WEBPACK_IMPORTED_MODULE_7__/* .messages.USER_DELETED_SUCCESSFULLY */ .s.USER_DELETED_SUCCESSFULLY, user);
    } catch (err) {
...
var __webpack_exports__ = __webpack_require__.X(0, [902,3796,104,6996,880,9707], () => (__webpack_exec__(1967)));
