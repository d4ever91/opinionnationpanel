...
handler.get(async (req, res)=>{
    try {
        ...
        var result = {};
        var data = await (0,_lib_middlewares_mongo_service__WEBPACK_IMPORTED_MODULE_6__/* .aggregateCategories */ .BF)([
            {
                $match: {
                    isDeleted: false
                }
        ...
        return (0,_lib_utils_response__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(req, res, _lib_utils_statusCodes__WEBPACK_IMPORTED_MODULE_4__/* ["default"].SUCCESS */ .Z.SUCCESS, "", "", result);
    } catch (err) {
...
var __webpack_exports__ = __webpack_require__.X(0, [3796,902,104,6996,880,9707], () => (__webpack_exec__(1373)));
